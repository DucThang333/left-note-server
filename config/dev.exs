...
config :left_note_server, LeftNoteServerWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "F9qxzyufnsJ637DHuE9jEDhv/Q/ibAwcw+kLnub8Nx393AQKq3kLciay/ELW/kjR",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:left_note_server, ~w(--sourcemap=inline --watch)]}
  ]
...
config :left_note_server, dev_routes: true
...
config :joken, default_signer: "development"
